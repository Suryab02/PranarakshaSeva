    ...
    <div className="min-h-screen bg-zinc-950 flex flex-col">
      ...
      <div className="flex-1 bg-zinc-900 rounded-t-3xl px-5 pt-5 pb-24">
        ...
        <div className="mt-5 grid grid-cols-2 gap-3">
          ...
          <button
            onClick={() => navigate('/guest/requests', { state: { city, blood } })}
            className="col-span-2 bg-red-600/10 hover:bg-red-600/20 border border-red-600/30 text-white rounded-2xl p-4 text-left transition-colors active:scale-[0.98] flex items-center gap-4"
          >
